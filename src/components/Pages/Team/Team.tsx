...
const emptyContent = () => {
  return <h1>This team has no associated repositories</h1>;
};
        ...
        >
          ...
          >
            {teamData?.offenses != undefined && (
              <Chip
                style={getColorStyling(teamData.offenses.length)}
                label={`${teamData.offenses.length} Repeat Vulnerabilities`}
              />
            )}
          </div>
        </div>
