...
export const OrgChoice = () => {
  ...
  return (
    <>
      ...
      <div style={divStyle}>
        <Typography variant="h4" style={{ marginBottom: '1.2rem', fontSize: '3.96em' }}>
        ...
        <Typography
          variant="h4"
          style={{ marginBottom: '4rem', fontSize: '1.72em', color: '#777d87', maxWidth: '40ch' }}
        >
          Select an organization and squash those nasty dependency vulnerabilities
        </Typography>
        <div
          style={{
            display: 'flex',
