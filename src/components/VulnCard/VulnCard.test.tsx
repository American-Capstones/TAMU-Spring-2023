...
describe('VulnCardBadge Test Suite', () => {
    ...
    describe('When a valid props are given', () => {
        ...
        it('should render', () => {
            ...
            expect(
                wrapper.contains(
                    <Typography variant='button'>{props[0].packageName}</Typography>
                )
            )
        })
        ...
        it('converts UTC into human readable format', () => {
            ...
            expect(
                wrapper.contains(
                    <Typography style={{ fontWeight: "normal", color: grey[600] }} variant='subtitle2'><span style={{ fontWeight: "bolder" }}>{format(props[0].createdAt)}</span></Typography>
                )
            )
        })
    })
