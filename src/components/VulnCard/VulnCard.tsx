          ...
          <div style={{ marginRight: '1.72em', marginBottom: 0, marginTop: 0 }}>
            ...
            <Tooltip title={utcToHuman(props.vuln.createdAt)}>
              <Typography style={{ fontWeight: 'normal', color: grey[600] }} variant="subtitle2">
                <span style={{ fontWeight: 'bolder' }}>{format(props.vuln.createdAt)}</span>
              </Typography>
            </Tooltip>
          </div>
          <div
        ...
        >
          ...
          <div>
            <Typography>
              ...
              {props.vuln.dismissedAt && <Typography>Dismissed {format(props.vuln.dismissedAt)}</Typography>}
              {props.vuln.fixedAt && <Typography>Fixed {format(props.vuln.fixedAt)}</Typography>}
            </Typography>
          </div>
        </div>
      </AccordionDetails>
      <AccordionActions>
        <Button target="_blank" href={props.vuln.url} color="primary">
          View on GitHub{' '}
        </Button>
      </AccordionActions>
    </Accordion>
