...
export async function getTeamNodes(
  graphql: any,
  orgLogin: string,
  teamLimit: number,
  ...
  let result: Teams<Team[]> | undefined = undefined;
  ...
  do {
    result = await graphql(
      ...
      {
        login: orgLogin,
        first: teamLimit > GITHUB_GRAPHQL_MAX_ITEMS ? GITHUB_GRAPHQL_MAX_ITEMS : teamLimit,
        endCursor: result ? result.organization.teams.pageInfo.endCursor : undefined,
      },
    );
    ...
    if (result) {
      ...
      teamNodes.push(...result.organization.teams.nodes);
    }
