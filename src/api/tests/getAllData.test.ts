...
describe('getVulnDataForRepos Test Suite', () => {
  ...
  it('return a valid objects when given all valid inputs (all vulns open)', async () => {
    // @ts-ignore
  ...
  // test("return a valid object when given all valid inputs (one vuln dismissed)", async () => {
